...
export const metadata: Metadata = {
  title: "Grandview Hotel - Luxury Accommodation & Five Star Service",
  description: "Experience unparalleled luxury at Grandview Hotel. Premium rooms, world-class amenities, fine dining, and exceptional service for the discerning traveler.",
  keywords: "luxury hotel, five star hotel, premium accommodation, fine dining, spa, business travel",
  openGraph: {
    title: "Grandview Hotel - Luxury Accommodation & Five Star Service",
  ...
  twitter: {
    ...
    title: "Grandview Hotel - Luxury Accommodation",
    description: "Experience unparalleled luxury at Grandview Hotel with premium rooms, world-class amenities, and exceptional service.",
